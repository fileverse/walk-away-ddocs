...
const OpenSource = () => {
  return (
    <div className="h-48 p-4 bg-[#fff9ce] rounded-lg flex-col justify-start items-start gap-3 inline-flex">
      <div className="self-stretch text-[#363b3f] text-xl font-bold  leading-7">
        Open source
      </div>
      <div className="self-stretch text-[#363b3f] text-base font-normal font-['Helvetica Neue'] leading-normal">
